...
const namePrefix = "MiceNFT";
const description = "5,000 uniquely generated characters. NO DUPLICATE!. Time to nest inside Ethereum blockchain.";
...
const GENERIC_DESCRIPTION = "we will surprise you with cool traits!"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeifp2zqfbdztnr2skct4gxm55f55h2pxr7duvanwnlldz6sd422vuq"; // Replace with your generic image that will display for all NFTs pre-reveal.
